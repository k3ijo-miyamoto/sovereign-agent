...
| --- | :---: | :---: | :---: | :---: |
| phi4:14b | 6/6 | 6/6 | 3.7 | ✅ 選抜 |
| qwen3:8b-nothink | 6/6 | 6/6 | 3.6 | ✅ 選抜 |
| qwen3:8b | 6/6 | 6/6 | 3.1 | ✅ 選抜 |
| deepseek-coder-v2:16b | 5/6 | 6/6 | 4.2 | ✅ 選抜 |
| devstral:24b | 5/6 | 6/6 | 2.8 | ✅ 選抜 |
| gemma3:12b | 5/6 | 6/6 | 2.9 | ✅ 選抜 |
| gemma3:27b | 5/6 | 6/6 | 2.9 | ✅ 選抜 |
| qwen2.5-coder:14b | 5/6 | 6/6 | 3.2 | ✅ 選抜 |
| qwen2.5:7b | 5/6 | 6/6 | 3.1 | ✅ 選抜 |
| qwen3:14b | 5/6 | 6/6 | 3.3 | ✅ 選抜 |
| codestral:22b | 4/6 | 6/6 | 2.6 | ✅ 選抜 |
| llama3.1:8b | 3/6 | 6/6 | 12.6 | ✅ 選抜 |
| mistral-nemo:12b | 2/6 | 6/6 | 4.0 | ✅ 選抜 |
| gemma3:4b | 1/6 | 6/6 | 2.6 | ✅ 選抜 |
| granite3.3:8b | 0/6 | 6/6 | 0.0 | ✅ 選抜 |

> **選抜基準**: T2 ≥ 5/6（6ケース中5ケース以上正解）を満たす8モデルをフェーズ2に進めた。

### フェーズ1 考察

**上位（T2 5/6以上）:** phi4:14b、qwen3:8b-nothink、qwen3:8b、deepseek-coder-v2:16b、devstral:24b、gemma3:12b、gemma3:27b、qwen2.5-coder:14b、qwen2.5:7b、qwen3:14b

**中位（T2 2〜4/6）:** codestral:22b、llama3.1:8b、mistral-nemo:12b

**下位（T2 0〜1/6）:** gemma3:4b、granite3.3:8b

**共通の弱点ケース:**

- **boundary_bug** — 73% のモデルが修正失敗（nth_fibonacci uses range(n) instead of range(n-1), off-by-one so results are one step ahead）

**XMLモード動作（Ollamaのtools API非対応）:** codestral:22b, deepseek-coder-v2:16b, devstral:24b, gemma3:12b, gemma3:27b, gemma3:4b, phi4:14b

**効率性（平均ツール呼び出し数）:**

- 少ない（効率的）: granite3.3:8b (0.0回)、codestral:22b (2.6回)、gemma3:4b (2.6回)
- 多い（非効率）: llama3.1:8b (12.6回)、deepseek-coder-v2:16b (4.2回)、mistral-nemo:12b (4.0回)
...
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| qwen3:8b-nothink | 100% | 100% | 100% | 33% | 100% | 100% | 89% |
| gemma3:27b | 100% | 100% | 100% | 0% | 100% | 100% | 83% |
| qwen2.5-coder:14b | 100% | 100% | 100% | 0% | 100% | 100% | 83% |
| qwen3:14b | 100% | 100% | 100% | 0% | 100% | 100% | 83% |
| qwen3:8b | 50% | 100% | 100% | 33% | 100% | 100% | 81% |
| devstral:24b | 100% | 100% | 100% | 0% | 100% | 67% | 78% |
| gemma3:12b | 67% | 100% | 100% | 0% | 100% | 100% | 78% |
| phi4:14b | 100% | 67% | 67% | 67% | 67% | 100% | 78% |
| qwen2.5:7b | 100% | 100% | 100% | 0% | 100% | 33% | 72% |
| deepseek-coder-v2:16b | 0% | 33% | 100% | 67% | 100% | 67% | 61% |
| codestral:22b | 100% | 100% | 67% | 0% | 0% | 33% | 50% |
| mistral-nemo:12b | 0% | 100% | 0% | 0% | 33% | 0% | 22% |
| llama3.1:8b | 33% | 0% | 0% | 0% | 33% | 33% | 17% |
| gemma3:4b | 0% | 33% | 0% | 0% | 0% | 0% | 6% |
| granite3.3:8b | 0% | 0% | 0% | 0% | 0% | 0% | 0% |
...
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| phi4:14b | 6/6 | 6/6 | 6/6 | 3.7 | 0/6 | 1/6 | 1/6 | 78% |
| qwen3:8b-nothink | 6/6 | 6/6 | 6/6 | 3.6 | 0/6 | 1/6 | 1/6 | 89% |
| qwen3:8b | 6/6 | 6/6 | 6/6 | 3.1 | 0/6 | 0/6 | 0/6 | 81% |
| deepseek-coder-v2:16b | 6/6 | 5/6 | 6/6 | 4.2 | 0/6 | 0/6 | 1/6 | 61% |
| devstral:24b | 6/6 | 5/6 | 6/6 | 2.8 | 0/6 | 1/6 | 2/6 | 78% |
| gemma3:12b | 5/6 | 5/6 | 6/6 | 2.9 | 0/6 | 2/6 | 0/6 | 78% |
| gemma3:27b | 6/6 | 5/6 | 6/6 | 2.9 | 0/6 | 1/6 | 0/6 | 83% |
| qwen2.5-coder:14b | 6/6 | 5/6 | 6/6 | 3.2 | 0/6 | 1/6 | 0/6 | 83% |
| qwen2.5:7b | 6/6 | 5/6 | 6/6 | 3.1 | 0/6 | 1/6 | 0/6 | 72% |
| qwen3:14b | 6/6 | 5/6 | 6/6 | 3.3 | 0/6 | 0/6 | 1/6 | 83% |
| codestral:22b | 4/6 | 4/6 | 6/6 | 2.6 | 0/6 | 3/6 | 0/6 | 50% |
| llama3.1:8b | 5/6 | 3/6 | 6/6 | 12.6 | 0/6 | 3/6 | 2/6 | 17% |
| mistral-nemo:12b | 4/6 | 2/6 | 6/6 | 4.0 | 0/6 | 5/6 | 0/6 | 22% |
| gemma3:4b | 2/6 | 1/6 | 6/6 | 2.6 | 0/6 | 5/6 | 0/6 | 6% |
| granite3.3:8b | 0/6 | 0/6 | 6/6 | 0.0 | 0/6 | 6/6 | 0/6 | 0% |
...
| --- | --- | :---: | :---: | ---: | --- |
| 精度・安定性最優先 | **qwen3:8b-nothink** | 6/6 | 89% | 5.2GB | T2+安定性ともに最高 |
| バランス重視 | **gemma3:27b** | 5/6 | 83% | 17.0GB | 精度・安定性・サイズのバランスが良い |
| 軽量（〜5GB） | **qwen3:8b-nothink** | 6/6 | 89% | 5.2GB | 小サイズで最高精度・安定性 |
| 非推薦 | granite3.3:8b | 0/6 | — | — | T2=0、実用不可 |

## 総合評価の結論

### 第1推薦: `qwen3:8b-nothink`

T2=6/6、安定性89%、calls=3.6（5.2GB）。安定性・精度ともにトップ。

### 第2推薦: `gemma3:27b`

T2=5/6、安定性83%、calls=2.9（17.0GB）。精度・安定性・サイズのバランスが良い。

### 軽量環境向け: `qwen3:8b-nothink`（第1推薦と同モデル）

5.2GB の小サイズでも精度・安定性ともに最高水準。軽量環境に最適。

### 想定外の発見

| 発見 | 内容 |
| --- | --- |
| **boundary_bug が最難関** | 全モデル中73%が失敗。解決できたのは `deepseek-coder-v2:16b`・`phi4:14b`・`qwen3:8b-nothink`・`qwen3:8b` のみ |
| **devstral:24b の過大評価** | エージェント特化を謳うが安定性78%・boundary_bug 0%。単回評価では見えなかった弱さが露呈 |
| **codestral:22b も同様** | 安定性50%、boundary_bug 3回とも失敗（0%）。コード特化モデルだが難しいケースで崩れる |
| **gemma3:27b の効率** | calls=2.9は読み込み・修正・確認の最小手数。無駄なループをしない |

### ソブリンAI実用観点での結論

「社内の機密コードを外部に送らずに自動修正したい」という用途において:

- **現時点で実用レベル**: `qwen3:8b-nothink`、`gemma3:27b`、`qwen2.5-coder:14b`、`qwen3:14b`、`qwen3:8b`、`phi4:14b`、`gemma3:12b`
- **軽量で十分**: `qwen2.5:7b`（小規模・定型タスク）
